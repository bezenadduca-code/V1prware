...
local function ttFireDagger()
    local re = svc.RS:FindFirstChild("Modules") and
               svc.RS.Modules:FindFirstChild("Network") and
               svc.RS.Modules.Network:FindFirstChild("Network") and
               svc.RS.Modules.Network.Network:FindFirstChild("RemoteEvent")
    if not re then return end
