delete anything containing the aimbot tab -- BetrayalHub - Complete Final Version with Guest 1337 Tab
...
function applyConfigFromFlags()
    pcall(function()
        ...
        if win.Flags.gvEspOn ~= nil then gvEsp.on=win.Flags.gvEspOn; if gvEsp.on then gvStartStandalone() else gvStopStandalone() end end
